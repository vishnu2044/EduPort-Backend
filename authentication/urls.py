...
from .views.otp_varification import ResendOtpVerification
...
urlpatterns = [
    ...
    path('resend-email-otp/', ResendOtpVerification.as_view(), name='-resend-verfiy-email(student/instructor)'),
